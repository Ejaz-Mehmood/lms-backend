...
async function run() {
  ...
  // ── English teachers ───────────────────────────────────────────────────────
  const newTeachers = [
    { firstName: 'James',  lastName: 'Mitchell', email: 'james.mitchell@mualimulquran.com', username: 'james.mitchell', contact: '+447911100601', cnic: '3520112346001', imageUrl: 'https://randomuser.me/api/portraits/men/44.jpg', timeZone: 'Europe/London',    shift: ['Morning','Afternoon'] },
    { firstName: 'Sarah',  lastName: 'Thompson', email: 'sarah.thompson@mualimulquran.com', username: 'sarah.thompson', contact: '+12025550602',  cnic: '3520112346002', imageUrl: 'https://randomuser.me/api/portraits/women/22.jpg', timeZone: 'America/New_York', shift: ['Evening'] },
  ];
  const addedTeachers = [];
